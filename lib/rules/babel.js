...
module.exports = {
  ...
  rules: {
    // eslint: require constructor names to begin with a capital letter (ignores decorators)
    'babel/new-cap': ['error', {capIsNew: false, newIsCap: true}],

    // eslint: disallow this keywords outside of classes or class-like objects (includes class properties)
